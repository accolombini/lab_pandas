# Nesta pratica nosso objetivo e trabalhar com filtros Booleanos de forma a ampliar nossa capacidade de manipulacao dos dados >>= nao devemos perder de vista que estamos pensando em um volume muito grande dados =>> Big Data >>= vamos fazer alguns slices observe
...
# Agora vamos iniciar o uso de filtros Booleanos <$> acompanhe estaremos aproveitando os dados trabalhados na aula anterior

print('\nNeste exemplo queremos extrair todos os dados da coluna A que sejam maiores que zero')
print('Observe que a logica sera aplicada apenas na coluna A, mas todas as outras serao exibidas ||> fique atento')
print(df[df.A > 0])

print('\nNeste exemplo queremos extrair todos os dados do DataFrame que sejam maiores que zero')
print(df[df > 0])